...
public class ViewWeeklyOfferKitchenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_weekly_offer_kitchen);
        connectivity();
        Handler handler = new Handler();
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                if (internetNotConnected(ViewWeeklyOfferKitchenActivity.this)) {
                    return;
                }
            }
        }, 1000);
        ...
        query = FirebaseDatabase.getInstance().getReference()
                .child("Weekly Offers").orderByChild("kitchenID").equalTo(mAuth.getCurrentUser().getUid());
        query.addListenerForSingleValueEvent(valueListener);

        adapter = new WeeklyOfferAdapter(this, weeklyOfferArrayList, "User");
    ...
    ValueEventListener valueListener = new ValueEventListener() {
        ...
        public void onCancelled(@NonNull DatabaseError databaseError) {
            Toast.makeText(ViewWeeklyOfferKitchenActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
        }
    };


    private void connectivity() {
        setTitle("My Weekly Menu");
        progressBar = findViewById(R.id.allOfferProgressBarK);
        allProRV = findViewById(R.id.allOfferKitRv);
        sp = getSharedPreferences(mysp, MODE_PRIVATE);
    ...
    private void showNoInternetMsg() {
        ...
        noInternetAlert.setOnCancelListener(new DialogInterface.OnCancelListener() {
            ...
            public void onCancel(DialogInterface dialog) {
                ...
                startActivity(i);
                Animatoo.animateSwipeLeft(ViewWeeklyOfferKitchenActivity.this);
                finish();
